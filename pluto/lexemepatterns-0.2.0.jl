...
tknanalysisurl =  "https://raw.githubusercontent.com/LinguaLatina/analysis/master/pluto/pluto-token-analyses.cex"

# ╔═╡ 6c9033b6-5fe5-11eb-3a26-03358ad850bd
# raw dataframe of data set
tknanalysesdf = CSV.File(HTTP.get(tknanalysisurl).body, skipto=2, delim="|") |> DataFrame

# ╔═╡ 2d9c2de0-60ec-11eb-2ce1-cd3b85a12a80
formstrings = collect(skipmissing(tknanalysesdf[:,:form]))

# ╔═╡ 2dd83876-60ee-11eb-2b53-39e75f28c872
(length(formstrings))

# ╔═╡ 5f025218-60eb-11eb-1e8f-23f566f7e143
pos = unique(map(f -> extractPos(f), formstrings))
...
md"*Choose number of lexemes*: $(@bind vocabsize Slider(1:numlexemes, show_value=true, default=10))"
...
md"""
**1. Lexicon of Hyginus, *Fabulae*: overview**
